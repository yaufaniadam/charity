      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 footer-widget xs-pr-20">
          ...
          <ul class="xs-social-list-v2">
            ...
            <li>
              <a href="" class="color-twitter"><i class="fa fa-twitter" /></a>
            </li>
            <li>
              <a href="" class="color-dribbble"><i class="fa fa-dribbble" /></a>
            </li>
            <li>
              <a href="" class="color-pinterest"><i class="fa fa-pinterest" /></a>
            </li>
          </ul>
          <!-- .xs-social-list END -->
        </div>
        ...
        <div class="col-lg-4 col-md-6 footer-widget">
          ...
          <ul class="xs-info-list">
            <li>
              <i class="fa fa-home" />Sector # 48, 123 Street, miosya road VIC
              28, Australia.
            </li>
            <li>
              <i class="fa fa-phone" />(800) 123.456.7890 (800) 123.456.7890 +00
              99 88 5647
            </li>
            <li>
              <i class="fa fa-envelope-o" /><a href="mailto:yourname@domain.com">yourname@domain.com</a>
            </li>
          </ul>
